...
for i=1
    ...
    index=1;
    number=num2str(i);
    proteinLocations=readmatrix('proteinBindingAndRemovalsCondition1.xlsx','Sheet',i);
    protoLengths=readmatrix('protofilamentLengthsCondition1.xlsx','Sheet',i);
 videoOutputName=strcat('protofilamentLengthsCondition1',num2str(i),'-20FPSBackground1For64nMPixelsEvery5Frames.avi');%Give the name for the output video
