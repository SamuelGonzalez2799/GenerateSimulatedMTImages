...
addpath('S:\LAB-klei0091\TaylorReid\MatlabCode\MicroTubule\Include')
PrepareFigureSize;
    ...
    otherwise 
        ...
        for ii=1:numI
            for jj=1:numJ
                ...
                pfLengths(ii,jj)={[12,9,10,10,10,8,14,13,10,11,12,9,9]};%{(longest-s*12:s:longest)};
                %
