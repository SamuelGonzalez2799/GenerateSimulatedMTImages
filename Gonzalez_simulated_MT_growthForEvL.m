...
for i=1
    ...
    index=1;
    number=num2str(i);
    proteinLocations=readmatrix('proteinBindingAndRemovalsWithEvL280StandardKineticsForPercentEB1AtEdge.xlsx','Sheet',i);
    protoLengths=readmatrix('protofilamentLengths280StandardKineticsForPercentEB1AtEdge.xlsx','Sheet',i);
 videoOutputName=strcat('protofilamentLengths280StandardKineticsForPercentEB1AtEdge',num2str(i),'-20FPSBackground1For64nMPixelsEvery5Frames.avi');%Give the name for the output video
